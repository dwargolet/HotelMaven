...
//        colNames.add("notes");
//        
//        values.add(hotel.getHotelName());
//        values.add(hotel.getStreetAddress());
//        values.add(hotel.getCity());
//        values.add(hotel.getState());
//        values.add(hotel.getZip());
//        values.add(hotel.getNotes());
//         
//      
//    }
//    
...
//    }
    ...
    public HotelDAO(DB_AccessorStrategy db, String url, String driver, String username, String password) {
        this.db = db;
        this.url = url;
        this.driver = driver;
        this.username = username;
